...
for root, dirs, files in os.walk(input_dir):
    ...
    for file_name in files:
        if file_name.endswith(".mp4") or file_name.endswith(".avi"):
            ...
            video_output_dir = os.path.join(output_dir, root.split('/')[1], video_name)
            ...
            # Divide the video into 1 segments and sample 16 frames from each segment
            for segment in range(1):
                start_frame = int(segment * (total_frames_in_video / 1))
                end_frame = int((segment + 1) * (total_frames_in_video / 1)) - 1
                ...
                for i in range(16):
                    ...
                    if ret:
                        ...
                        # output_file_name = f"{video_name}_segment_{segment}_frame_{i}.jpg"
            ...
            print(f"Warning: Directory '{video_output_dir}' already exists. Skipping.")
