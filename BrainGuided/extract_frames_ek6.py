...
input_dir = "EK6--raw" # VideoEmotion8--raw, EK6--raw
output_dir = "EK6--imgs" # VideoEmotion8--imgs, EK6--imgs
...
for root, dirs, files in os.walk(input_dir):
    for file_name in files:
        if file_name=="3796776541_932372979e_700.mp4":#file_name.endswith(".mp4") or file_name.endswith(".avi"):
