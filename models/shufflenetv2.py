...
def pretrained_shufflenet_v2(snippet_duration: int,
                         sample_size: int,
                         n_classes,
    ...
    print('Loading pretrained 3D shufflenet_v2 {}'.format(pretrained_model_path))
...
def pretrained_shufflenet_v2_1(snippet_duration: int,
                         sample_size: int,
                         n_classes,
                         pretrained_model_path):
    n_finetune_classes = 600
