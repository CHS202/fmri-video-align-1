...
def pretrained_mobilenet_v2(snippet_duration: int,
                         sample_size: int,
                         n_classes,
                         pretrained_model_path):
    n_finetune_classes = 600
    model = get_model(num_classes=600, sample_size = sample_size, width_mult=0.45)
    model = model.cuda()
    print('Loading pretrained 3D mobilenet_v2 {}'.format(pretrained_model_path))
...
def pretrained_mobilenet_v2_1(snippet_duration: int,
                         sample_size: int,
                         n_classes,
                         pretrained_model_path):
    n_finetune_classes = 600
